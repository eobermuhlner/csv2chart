...
public class BarChartFactory extends AbstractChartFactory {
	...
	public JFreeChart createChart(DataModel dataModel, Parameters parameters) {
		...
		JFreeChart chart = org.jfree.chart.ChartFactory.createBarChart(parameters.title, parameters.xAxisLabel, parameters.yAxisLabel, categoryDataset, PlotOrientation.VERTICAL, legend, true, false);
		return chart;
	}
}
